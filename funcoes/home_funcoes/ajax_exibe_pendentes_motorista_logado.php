...
<div class="row">
    ...
    ?>
            <div onclick="ajax_alert('Deseja começar esta corrida?','ajax_motorista_recebe_designacao(<?php echo $row_table['CD_CHAMADO_DESIGNADO']; ?>)')" class="col-12 col-md-3" style="background-color: rgba(0,0,0,0) !important; padding-top: 0px; padding-bottom: 0px;">
    <?php
