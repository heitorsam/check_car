...
CREATE TABLE portal_check_car.VEICULO(
       ...
       KM INT NOT NULL,
       TP_STATUS VARCHAR(1), -- I - INATIVO A - ATIVO
       CD_USUARIO_CADASTRO VARCHAR(20) NOT NULL,
       HR_CADASTRO TIMESTAMP(6) NOT NULL,
       CD_USUARIO_ULT_ALT VARCHAR(20),
       HR_ULT_ALT TIMESTAMP(6),
...
CREATE TABLE portal_check_car.CHECKLIST(
       ...
       TP_CHECKLIST VARCHAR(1) NOT NULL, --(S) SAIDA --(R) RETORNO -- (Z) PENDENTE DE SAIDA -- (X) PENDENTE DE RETORNO
       CD_VEICULO INT NOT NULL,
       TP_PLANTAO VARCHAR(1),
       OBS_GERAL VARCHAR(200),
       CD_USUARIO_CADASTRO VARCHAR(20) NOT NULL,
       HR_CADASTRO TIMESTAMP(6) NOT NULL,
       CD_USUARIO_ULT_ALT VARCHAR(20),
       HR_ULT_ALT TIMESTAMP(6),
...
DROP TABLE portal_check_car.CHAMADOS_DESIGNADOS;

CREATE TABLE portal_check_car.CHAMADOS_DESIGNADOS(
CD_CHAMADO_DESIGNADO INT NOT NULL,
CD_MOTORISTA         INT NOT NULL,
CD_OS_MV             INT NOT NULL,
TP_STATUS_CHAMADO    VARCHAR(1),  --D (DESIGNADO) / -- A (ACEITO) / -- C CONCLUIDO
CD_USUARIO_CADASTRO  VARCHAR(20) NOT NULL,
HR_CADASTRO          TIMESTAMP(6) NOT NULL,
CD_USUARIO_ULT_ALT   VARCHAR(20),
HR_ULT_ALT           TIMESTAMP(6),
...
--PRIMARY KEY
CONSTRAINT PK_CD_CHAMADO_DESIGNADO PRIMARY KEY (CD_CHAMADO_DESIGNADO)

);

DROP SEQUENCE portal_check_car.SEQ_CD_CHAMADO_DESIGNADO;
CREATE SEQUENCE portal_check_car.SEQ_CD_CHAMADO_DESIGNADO
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;
...
DROP TABLE portal_check_car.SAI_RET_VEICULO;

CREATE TABLE portal_check_car.SAI_RET_VEICULO(

CD_SAI_RET INT NOT NULL,
CD_CHAMADO_DESIGNADO INT NOT NULL,
CD_MOTORISTA INT NOT NULL,
CD_VEICULO INT NOT NULL,
HR_SAIDA   TIMESTAMP(6),
HR_RETORNO TIMESTAMP(6),
KM_SAIDA   VARCHAR(100),
KM_RETORNO VARCHAR(100),
CD_USUARIO_CADASTRO  VARCHAR(20) NOT NULL,
HR_CADASTRO          TIMESTAMP(6) NOT NULL,
CD_USUARIO_ULT_ALT   VARCHAR(20),
HR_ULT_ALT           TIMESTAMP(6),
...
--PRIMARY KEY
CONSTRAINT PK_CD_SAI_RET PRIMARY KEY (CD_SAI_RET)

);

DROP SEQUENCE portal_check_car.SEQ_CD_SAI_RET;

CREATE SEQUENCE portal_check_car.SEQ_CD_SAI_RET
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;

DROP TABLE portal_check_car.ABASTECIMENTO;

CREATE TABLE portal_check_car.ABASTECIMENTO(
CD_ABASTECIMENTO INT NOT NULL,
CD_VEICULO       INT NOT NULL,
DS_KM            VARCHAR(100),
DS_LITROS        VARCHAR(100),
...
--PRIMARY KEY
CONSTRAINT PK_CD_ABASTECIMENTO PRIMARY KEY (CD_ABASTECIMENTO)

);

DROP SEQUENCE portal_check_car.SEQ_CD_ABASTECIMENTO;

CREATE SEQUENCE portal_check_car.SEQ_CD_ABASTECIMENTO
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;
...
DROP TABLE portal_check_car.RATEIO;

CREATE TABLE portal_check_car.RATEIO(
CD_OS                INT NOT NULL,
...
/*
--PRIMARY KEY
CONSTRAINT PK_CD_RATEIO PRIMARY KEY (CD_RATEIO)

);

DROP SEQUENCE portal_check_car.SEQ_CD_RATEIO;

CREATE SEQUENCE portal_check_car.SEQ_CD_RATEIO
START WITH 1
INCREMENT BY 1
NOCACHE
NOCYCLE;
